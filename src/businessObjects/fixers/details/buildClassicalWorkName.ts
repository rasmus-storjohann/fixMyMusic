...
export function buildClassicalWorkName(json): ClassicalWorkName
{
...
function validateClassicalWorkName(name: ClassicalWorkName) : ClassicalWorkName
{
...
function parseOpus(from): Opus | undefined
{
...
function validateLengthIsTwo(item: string[])
{
        if (item.length !== 2)
        {
