...
export var rules = {
    ...
    "CelloSonata1" : {
        ...
        fixTrackName: /Sonata for Cello and Piano No. 1 in F major, Op. 5 No. 1: [IV]+\. (.*)\.mp3/
    },
    "CelloSonata2" : {
        firstTrackNumber: 3,
        fixAlbumTitle: sonata({num:2, for:"Cello",minor:"G",op:[5, 2] }),
        fixTrackName: /Sonata for Cello and Piano No. 2 in G minor, Op. 5 No. 2: [IV]+\. (.*)\.mp3/
    },
    "CelloSonata3" : {
        firstTrackNumber: 5,
        fixAlbumTitle: sonata({num:3, for:"Cello", major:"A", op:69 }),
        fixTrackName: /Sonata for Cello and Piano No. 3 in A major, Op. 69: [IV]+\. (.*)\.mp3/
    },
    "CelloSonata4" : {
        fixAlbumTitle: sonata({num:4, for:"Cello", op:[102,1] }),
        fixTrackName: /Cello Sonata 4 Op 102 No 1 - \d - (.*).mp3/
    },
    "CelloSonata5" : {
        firstTrackNumber: 3,
        fixAlbumTitle: sonata({num:5, for:"Cello", op:[102,2] }),
        fixTrackName: /Cello Sonata 5 Op 102 No 2 - \d - (.*).mp3/
    },
    "Chorphantasie" : {
        // TODO check tracks on this, finale is not the last track!
        firstTrackNumber: 4,
        fixTrackName: /.*(Adagio|Finale|Allegro).mp3/
    },
    "Diabelli[Demidenko]" : {
        firstTrackNumber: 3,
    ...
    "GrosseFuge [Tokyo]" : {
        firstTrackNumber: 6,
        fixTrackName: /(Große Fuge) in B-flat major for String Quartet op. 133: Overtura. Allegro - Meno mosso e moderato - Allegro - Fuga. \[Allegro\] - Meno mosso e moderato - Allegro molto e con brio - Allegro.mp3/
    },
    ...
    "Quartet1 [Tokyo]" : {
        ...
        fixTrackName: /String Quartet no. 1 in F major, op. 18-1: [IV]+\. (.*)\.mp3/
    },
    "Quartet2 [Tokyo]" : {
        firstTrackNumber: 5,
        fixAlbumTitle: quartet({num:2, major:"G", op:[18,2], by:"Tokyo"}),
        fixTrackName: /String Quartet no. 2 in G major, op. 18-2: [IV]+\. (.*)\.mp3/
    },
    ...
    "Quartet3 [Tokyo]" : {
        ...
        fixTrackName: /String Quartet no. 3 in D major, op. 18-3: [IV]+\. (.*)\.mp3/
    },
    ...
    "Quartet4 [Tokyo]" : {
        ...
        fixTrackName: /String Quartet no. 4 in C minor, op. 18-4: [IV]+\. (.*)\.mp3/
    },
    "Quartet5 [Tokyo]" : {
        fixAlbumTitle: quartet({num:5, major:"A", op:[18,5], by:"Tokyo"}),
        fixTrackName: /String Quartet no. 5 in A major, op. 18-5: [IV]+\. (.*)\.mp3/
    },
    ...
    "Quartet6 [Tokyo]" : {
        ...
        fixTrackName: /String Quartet no. 6 in B-flat major, op. 18-6: [IV]+\. (.*)\.mp3/
    },
    "Quartet7 [Tokyo]" : {
        fixAlbumTitle: quartet({num:7, major:"F", op:[59,1], by:"Tokyo"}),
        fixTrackName: /String Quartet no. 7 in F major, op. 59-1 “Rasumovsky”: [IV]+\. (.*)\.mp3/
    },
    "Quartet8 [Tokyo]" : {
        fixAlbumTitle: quartet({num:8, minor:"E", op:[59,2], by:"Tokyo"}),
        fixTrackName: /String Quartet no. 8 in E minor, op. 59-2 “Rasumovsky”: [IV]+\. (.*)\.mp3/
    },
    "Quartet9 [Tokyo]" : {
        fixAlbumTitle: quartet({num:9, major:"C", op:[59,3], by:"Tokyo"}),
        fixTrackName: /String Quartet no. 9 in C major, op. 59-3 “Rasumovsky”: [IV]+\. (.*)\.mp3/
    },
    "Quartet10 [Tokyo]" : {
        firstTrackNumber: 5,
        fixAlbumTitle: quartet({num:10, major:"Eb", op:74, subTitle:"Harp", by:"Tokyo"}),
        fixTrackName: /String Quartet no. 10 in E-flat major, op. 74 \“Harp\”: [IV]+\. (.*)\.mp3/
    },
    "Quartet11 [Tokyo]" : {
        firstTrackNumber: 5,
        fixAlbumTitle: quartet({num:11, minor:"F", op:95, subTitle:"Serioso", by:"Tokyo"}),
        fixTrackName: /String Quartet no. 11 in F minor, op. 95 \“Serioso\”: [IV]+\. (.*)\.mp3/
    },
    "Quartet12 [Tokyo]" : {
        fixAlbumTitle: quartet({num:12, major:"Eb", op:127, by:"Tokyo"}),
        fixTrackName: /String Quartet no. 12 in E-flat major, op\. 127: [IV]+\. (.*)\.mp3/
    },
    "Quartet12[Lindsay]" : {
        fixAlbumTitle: quartet({num:12, major:"Eb", op:127, by:"Lindsay"}),
        fixTrackName: /Quartet 12 Op 127 - \d+ - (.*)\.mp3/
    },
    "Quartet13[Tokyo]" : {
        fixAlbumTitle: quartet({num:13, major:"Bb", op:130, by:"Tokyo"}),
        fixTrackName: /String Quartet no. 13 in B-flat major, op. 130: [IV]+\. (.*).mp3/
    },
    "Quartet13[Lindsay]" : {
        fixAlbumTitle: quartet({num:13, major:"Bb", op:130, by:"Lindsay"}),
        fixTrackName: /Quartet no. 13 in B-flat major, op. 130: [IV]+\. (.*).mp3/
    },
    ...
    "Quartet14[Lindsay]" : {
        ...
        fixTrackName: /Quartet for 2 Violins, Viola, and Cello no. 14 in C-sharp minor, op. 131: [IV]+\. (.*)\.mp3/,
        validation : ["skipUniqueTrackNameCheck"]
    },
    ...
    "Quartet14 [Tokyo]" : {
        ...
        fixTrackName: /String Quartet no. 14 in C-sharp minor, op. 131: [IV]+\. (.*)\.mp3/
    },
    "Quartet15[Lindsay]" : {
        fixAlbumTitle: quartet({num:15, minor:"A", op:132, by:"Lindsay"}),
        fixTrackName: /Quartet for 2 Violins, Viola, and Cello no. 15 in A minor, op. 132: [IV]+\. (.*)\.mp3/
    },
    "Quartet15 [Tokyo]" : {
        fixAlbumTitle: quartet({num:15, minor:"A", op:132, by:"Tokyo"}),
        fixTrackName: /String Quartet no. 15 in A minor, op. 132: [IV]+\. (.*)\.mp3/
    },
    "Quartet16[Lindsay]" : {
        firstTrackNumber: 6,
        fixAlbumTitle: quartet({num:16, major:"F", op:135, by:"Lindsay"}),
        fixTrackName: /Quartet for 2 Violins, Viola, and Cello no. 16 in F major, op. 135: [IV]+\. (.*)\.mp3/
    },
    "Quartet16 [Tokyo]" : {
        firstTrackNumber: 6,
        fixAlbumTitle: quartet({num:16, major:"F", op:135, by:"Tokyo"}),
        fixTrackName: /String Quartet no. 16 in F major, op. 135: [IV]+\. (.*).mp3/
    },
    ...
    "Quintet [Tokyo]" : {
        ...
        fixTrackName: /String Quartet in C major, op. 29: [IV]+\. (.*).mp3/
    },
    "Sonata1[Goode]" : {
        fixAlbumTitle: sonata({ num : 1, op:[2, 1], minor : "f", by: "Goode" }),
        fixTrackName: /Goode - Piano Sonata No.1 F minor [IV]+\. (.*)\.mp3/
    },
    "Sonata1[Gould]" : {
        fixAlbumTitle: sonata({ num : 1, op:[2, 1], minor : "f", by: "Gould" }),
        fixTrackName: /Sonata No. 1 in F minor, Op. 2, No. 1 - [IV]+\. (.*).mp3/
    },
    "Sonata2[Goode]" : {
        fixAlbumTitle: sonata({ num : 2, op:[2, 2], major : "A", by: "Goode" }),
        firstTrackNumber: 5,
        fixTrackName: /Goode - Piano Sonata No.2 A major [IV]+\. (.*)\.mp3/
    },
    "Sonata2[Gould]" : {
        fixAlbumTitle: sonata({ num : 2, op:[2, 2], major : "A", by: "Gould" }),
        firstTrackNumber: 5,
        fixTrackName: /Sonata No. 2 in A major, Op. 2, No. 2 - [IV]+\. (.*).mp3/
    },
    "Sonata2-Gilels" : {
        fixAlbumTitle: sonata({ num : 2, op:[2, 2], major : "A", by: "Gilels" }),
        fixTrackName: /Sonate No.2 A-dur op.2 No.2 - \d\. (.*)\.mp3/
    },
    "Sonata3[Goode]" : {
        fixAlbumTitle: sonata({ num : 3, op:[2, 3], major : "C", by: "Goode" }),
        firstTrackNumber: 9,
        fixTrackName: /Goode - Piano Sonata No.3 in C major [IV]+\. (.*)\.mp3/
    },
    "Sonata3[Gould]" : {
        fixAlbumTitle: sonata({ num : 3, op:[2, 3], major : "C", by: "Gould" }),
        firstTrackNumber: 9,
        fixTrackName: /Sonata No. 3 in C major, Op. 2, No. 3 - [IV]+\. (.*)\.mp3/
    },
    "Sonata3-Gilels" : {
        fixAlbumTitle: sonata({ num : 3, op:[2, 3], major : "C", by: "Gilels" }),
        firstTrackNumber: 5,
        fixTrackName: /Sonate No.3 C-Dur, op. 2 No.3 - \d\. (.*)\.mp3/
    },
    "Sonata4[Goode]" : {
    ...
    "Sonata4-Gilels" : {
        ...
        fixTrackName: /Sonate No.4 Es-dur op.7 - \d\. (.*)\.mp3/
    },
    "Sonata5[Goode]" : {
        fixAlbumTitle: sonata({ num : 5, op:[10, 1], minor : "C", by: "Goode" }),
        fixTrackName: /No.5 in C minor, op.10, no.1- (.*)\.mp3/
    },
    "Sonata5[Gould]" : {
        fixAlbumTitle: sonata({ num : 5, op:[10, 1], minor : "C", by: "Gould" }),
        fixTrackName: /Sonata No. 5 in C minor, Op. 10, No. 1 - [IV]+\. (.*).mp3/
    },
    "Sonata5-Gilels" : {
        fixAlbumTitle: sonata({ num : 5, op:[10, 1], minor : "C", by: "Gilels" }),
        fixTrackName: /Piano Sonata No. 5 in C minor, Op. 10 No. 1 \d\. (.*)\.mp3/
    },
    "Sonata6[Goode]" : {
        fixAlbumTitle: sonata({ num : 6, op:[10, 2], major : "F", by: "Goode" }),
        firstTrackNumber: 4,
        fixTrackName: /No.6 in F major, op.10, no.2- (.*).mp3/
    },
    "Sonata6[Gould]" : {
        fixAlbumTitle: sonata({ num : 6, op:[10, 2], major : "F", by: "Gould" }),
        firstTrackNumber: 4,
        fixTrackName: /Sonata No. 6 in F major, Op. 10, No. 2 - [IV]+\. (.*)\.mp3/
    },
    "Sonata6-Gilels" : {
        fixAlbumTitle: sonata({ num : 6, op:[10, 2], major : "F", by: "Gilels" }),
        firstTrackNumber: 4,
        fixTrackName: /Piano Sonata No. 6 in F major, Op. 10 No. 2 \d\. (.*)\.mp3/
    },
    "Sonata7[Goode]" : {
        fixAlbumTitle: sonata({ num : 7, op:[10, 3], major : "D", by: "Goode" }),
        firstTrackNumber: 7,
        fixTrackName: /No.7 in D major, op.10, no.3- (.*)\.mp3/
    },
    "Sonata7[Gould]" : {
        fixAlbumTitle: sonata({ num : 7, op:[10, 3], major : "D", by: "Gould" }),
        firstTrackNumber: 7,
        fixTrackName: /Sonata No. 7 in D major, Op. 10, No. 3 - [IV]+\. (.*)\.mp3/
    },
    "Sonata7-Gilels" : {
        fixAlbumTitle: sonata({ num : 7, op:[10, 3], major : "D", by: "Gilels" }),
        firstTrackNumber: 7,
        fixTrackName: /Piano Sonata No. 7 in D major, Op. 10 No. 3 \d\. (.*)\.mp3/
    },
    "Sonata8[Goode]" : {
    ...
    "Sonata8[Gould]" : {
        ...
        fixTrackName: /Sonata No.8 IN C Minor, Op.13 'Pathetique'- [IV]+\. (.*)\.mp3/
    },
    "Sonata8-Gilels" : {
        fixAlbumTitle: sonata({ num : 8, op:13, subTitle: "Pathetique", minor : "C", by: "Gilels" }),
        firstTrackNumber: 5,
        fixTrackName: /Sonate No.8 C-Moll Op. 13 'Pathétique' - \d\. (.*)\.mp3/
    },
    "Sonata9[Goode]" : {
    ...
    "Sonata19-Gilels" : {
        ...
        fixTrackName: /Sonate No.19 g-moll op.49 No.1 - \d\. (.*)\.mp3/
    },
    "Sonata20[Goode]" : {
        firstTrackNumber: 3,
    ...
    "Sonata24[Gould] \"À Thérèse\"" : {
        ...
        fixTrackName: /Sonata No. 24 in F-sharp major, Op. 78 \"À Thérèse\": I+\. (.*).mp3/
    },
    "Sonata25[Goode]" : {
        firstTrackNumber: 7,
    ...
    "Sonata25-Gilels" : {
        ...
        firstTrackNumber: 11,
        fixTrackName: /Sonate No.25 G-dur op. 79 - \d\. (.*)\.mp3/
    },
    "Sonata26[Goode]" : {
        firstTrackNumber: 10,
    ...
    "Sonata26-Gilels" : {
        ...
        fixTrackName: /Sonate No.26 Es-dur op. ?81a 'Les Adieux' - \d\. (.*)\.mp3/
    },
    "Sonata27[Goode]" : {
        firstTrackNumber: 13,
        fixAlbumTitle: sonata({ num : 27, op:90, minor : "E", by: "Goode" }),
        fixTrackName: /No.27 in E minor, op.90- (.*)\.mp3/
    },
    "Sonata27-Gilels" : {
        fixAlbumTitle: sonata({ num : 27, op:90, minor : "E", by: "Gilels" }),
        firstTrackNumber: 4,
        fixTrackName: /Sonate No.27 e-moll op. ?90 - \d\. (.*)\.mp3/
    },
    "Sonata28[Richter]" : {
        firstTrackNumber: 7,
    ...
    "Sonata28-Gilels" : {
        ...
        fixTrackName: /Sonata No.28 in A major, Op.101 - \d\. (.*)\.mp3/
    },
    "Sonata28[Goode]" : {
    ...
    "Sonata29[Gould] \"Hammerklavier\"" : {
        ...
        fixTrackName: /Sonata No. 29 in B-flat major, Op. 106 "Hammerklavier": [IV]+\. (.*)\.mp3/
    },
    "Sonata29-Gilels" : {
        fixAlbumTitle: sonata({ num : 29, subTitle: "Hammerklavier", op:106, major : "Bb", by: "Gilels" }),
       firstTrackNumber: 5,
       fixTrackName: /Sonata No.29 in B dur, Op.106 Hammerklavier - \d\. (.*)\.mp3/
    },
    "Sonata30[Goode]" : {
        fixAlbumTitle: sonata({ num : 30, op:109, major : "E", by: "Goode" }),
        fixTrackName: /Sonata No.30 in E major, Op.109 - [IV]+\. (.*).mp3/
    },
    "Sonata30[Gould]" : {
    ...
    "Sonata30-Gilels" : {
        ...
        firstTrackNumber: 6,
        fixTrackName: /Sonate No.30 E-dur op.109 - \d\. (.*)\.mp3/
    },
    "Sonata31[Goode]" : {
        firstTrackNumber: 4,
        fixAlbumTitle: sonata({ num : 31, op:110, major : "Ab", by: "Goode" }),
        fixTrackName: /Sonata No.31 in A flat major, Op.110 - [IV]+\. (.*)\.mp3/
    },
    "Sonata31[Gould]" : {
        firstTrackNumber: 4,
    ...
    "Sonata31-Gilels" : {
        ...
        firstTrackNumber: 15,
        fixTrackName: /Sonate No.31 As-dur op.110 - \d\. (.*)\.mp3/
    },
    "Sonata32[Goode]" : {
        firstTrackNumber: 7,
        fixAlbumTitle: sonata({ num : 32, op:111, minor : "C", by: "Goode" }),
        fixTrackName: /Sonata No.32 in C minor, Op.111 - [IV]+\. (.*)\.mp3/
    },
    "Sonata32[Gould]" : {
        firstTrackNumber: 7,
    ...
    "SonataWoo47-1-Gilels" : {
        firstTrackNumber: 9,
        fixTrackName: /Sonate Es-dur WoO 47 No.1 - \d\. (.*)\.mp3/
    },
    "SonataWoo47-2-Gilels" : {
       firstTrackNumber: 12,
       fixTrackName: /Sonate f-moll WoO 47 No.2 - \d\. (.*)\.mp3/
    },
    "Symph1[Karajan]" : {
        fixAlbumTitle: symphony({ num : 1, op:21, major : "C", by: "Karajan" }),
        fixTrackName: /Symphonie Nr. 1 C-dur op. 21: \d+\. (.*)\.mp3/
    },
    "Symph1[Norrington]" : {
    ...
    "Symph2[Karajan]" : {
        ...
        fixTrackName: /Symphonie Nr. 2 D-dur op. 36: \d+\. (.*)\.mp3/
    },
    "Symph2[Norrington]" : {
    ...
    "Symph3[Haitink]" : {
        ...
        fixTrackName: /Symphony no. 3 in E‐flat major, op. 55 \“Eroica\”: [IV]+\. (.*)\.mp3/
    },
    "Symph3[Karajan]" : {
        firstTrackNumber: 5,
        fixAlbumTitle: symphony({ num : 3, subTitle:"Eroica", op:55, major : "Eb", by: "Karajan" }),
        fixTrackName: /Symphonie Nr. 3 in Es-dur op. 55 \»Eroica\«: \d+\. (.*)\.mp3/
    },
    "Symph3[Norrington]" : {
        firstTrackNumber: 2,
    ...
    "Symph4[Karajan]" : {
       ...
       fixTrackName: /Symphonie Nr. 4 B-dur op. 60: \d+\. (.*)\.mp3/
   },
   "Symph4[Norrington]" : {
   ...
   "Symph5[Karajan]" : {
       fixAlbumTitle: symphony({ num : 5, op:67, minor : "c", by: "Karajan" }),
        fixTrackName: /Symphonie Nr. 5 c-moll op. 67: \d+\. (.*)\.mp3/
    },
    "Symph5[Kleiber]" : {
    ...
    "Symph6[Karajan]" : {
        ...
        fixTrackName: /Symphonie Nr. 6 F-dur op. 68 \»Pastorale\«: \d\. (.*)\.mp3/
    },
    "Symph6[Norrington]" : {
        firstTrackNumber: 5,
    ...
    "Symph7[Karajan]" : {
        ...
        fixTrackName: /Symphonie Nr. 7 A-dur op. 92: \d+\. (.*)\.mp3/
    },
    "Symph7[Kleiber]" : {
        firstTrackNumber: 5,
    ...
    "Symph8[Karajan]" : {
        ...
        fixTrackName: /Symphonie Nr. 8 F-dur op. 93: \d+\. (.*)\.mp3/,
        validation : ["skipUniqueTrackNameCheck"]
    },
    "Symph8[Norrington]" : {
        firstTrackNumber: 5,
    ...
    "ViolinSonata1 Op12No1" : {
        ...
        fixTrackName: /Sonata for Violin and Piano in D major, Op. 12 No. 1 [IV]+\. (.*)\.mp3/
    },
    ...
    "ViolinSonata10 Op96" : {
        firstTrackNumber: 7,
        fixAlbumTitle: sonata({ for:"Violin", num : 10, op:96, major: "G" }),
        fixTrackName: /Sonata for Violin and Piano in G major, Op. 96 [IV]+\. (.*).mp3/
    },
   ...
   "ViolinSonata2 Op12No2" : {
        ...
        fixTrackName: /Sonata for Violin and Piano in A major, Op. 12 No. 2 [IV]+\. (.*)\.mp3/
    },
    "ViolinSonata3 Op12No3" : {
        firstTrackNumber: 7,
        fixAlbumTitle: sonata({ for:"Violin", num : 3, op:[12,3], major: "Eb" }),
        fixTrackName: /Sonata for Violin and Piano in E-flat major, Op. 12 No. 3 [IV]+\. (.*)\.mp3/
    },
    "ViolinSonata4 Op23" : {
        firstTrackNumber: 10,
        fixAlbumTitle: sonata({ for:"Violin", num : 4, op:23, minor: "A" }),
        fixTrackName: /Sonata for Violin and Piano in A minor, Op. 23 [IV]+\. (.*)\.mp3/
    },
    "ViolinSonata5 Op24 \"Frühling\"" : {
        fixAlbumTitle: sonata({ for:"Violin", num : 5, op:24, major: "F", subTitle:"Frühling" }),
        fixTrackName: /Sonata for Violin and Piano in F major, Op. 24 \“Frühling\” [IV]+\. (.*)\.mp3/
    },
    ...
    "ViolinSonata6 Op30No1" : {
        ...
        fixTrackName: /Sonata for Violin and Piano in A major, Op. 30 No. 1 [IV]+\. (.*)\.mp3/
    },
    ...
    "ViolinSonata9 Op47 \"Kreutzer\"" : {
        firstTrackNumber: 4,
        fixAlbumTitle: sonata({ for:"Violin", num : 9, op:47, major: "A", subTitle:"Kreutzer" }),
        fixTrackName: /Sonata for Violin and Piano in A major, Op. 47 \“Kreutzer\” [IV]+\. (.*).mp3/
    }
};
