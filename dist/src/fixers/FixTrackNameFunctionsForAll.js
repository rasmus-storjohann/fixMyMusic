...
function BachFantasias(name, logger) {
...
function BachGoldBergStrings(name, logger) {
...
function BachInventionsGould(name, logger) {
...
function BachStJohnPassion(name, logger) {
...
function WellTempOneFellner(name, logger) {
...
function WellTempOneGould(name, logger) {
...
function WellTempTwoGould(name, logger) {
...
function WellTempTwoTureck(name, logger) {
    var trackNumber, key, type;
...
function DiabelliDemidenko(name, logger) {
    return name === "- Track 3" ? "Theme" : "Variation";
}
function WozzekActOne(name, logger) {
...
function TurnOfTheScrewActOne(name, logger) {
...
function ShostakovichPreludesFugues(name, logger) {
    var parseFirstFormat = function (name) {
    ...
    var parseSecondFormat = function (name) {
    ...
    var formatKey = function (key, sharpOrFlat, minorOrMajor) {
...
function VivaldiFourSeasonsMarriner(name, logger) {
...
function VivaldiFourSeasonsKennedy(name, logger) {
...
exports.FixTrackNameFunctionsForAll = {
    "JS Bach": {
